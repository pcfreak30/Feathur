<div id="LoadingImage" align="right" style="padding-right:10px;margin-top:10px;visibility:hidden;"><img
            src="./templates/default/img/loading/9.gif"></img></div>
                ...
                <div class="simplebox grid740" style="width:99%">
                    <div class="titleh">
                        ...
                        <div class="shortcuts-icons">
                            <a class="shortcut tips" id="AddIP" title="Add IP Address(es)"><img
                                        src="./templates/default/img/icons/shortcut/addfile.png" width="25" height="25"
                                        alt="icon"/></a>
                        </div>
                    </div>
                    <table class="tablesorter" id="IPAddresses">
                        ...
                        <tr>
                            <td>{%?ip[ip]}</td>
                            <td>{%if isempty|ip[OwnerId] == false}
                                <div align="center"><a
                                            href="admin.php?view=clients&id={%?ip[OwnerId]}">{%?ip[Owner]}</a>
                                </div>{%/if}</td>
                            <td>
                                <div align="center">
                                    <a original-title="Delete" class="icon-button tips DeleteIP"
                                       style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?ip[ip]}"
                                       value="{%?ip[id]}"><img src="./templates/default/img/icons/32x32/stop32.png"
            ...
            <div align="center">
                <div class="simplebox grid740" style="width:99%">
                    <div class="titleh">
                        ...
                        <div class="shortcuts-icons">
                            <a class="shortcut tips" id="AddServer" title="Add Server to Block"><img
                                        src="./templates/default/img/icons/shortcut/addfile.png" width="25" height="25"
                                        alt="icon"/></a>
                        </div>
                    </div>
                    <table class="tablesorter" id="Servers">
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="center">
                                    <a original-title="Delete" class="icon-button tips DeleteServer"
                                       style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?server[name]}"
                                       value="{%?server[id]}"><img src="./templates/default/img/icons/32x32/stop32.png"
                                                                   alt="icon" height="16" width="16"></a>
                                </div>
                            </td>
                        </tr>
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:90px;">
                <form id="form1" name="form1" class="SubmitBlockForm noEnterSubmit">
                    IP Address: <input name="singleip" class="st-forminput" id="SingleIPAdd" style="width:150px"
                                       type="text"><br>

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="SubmitNewIPWrapper"><a class="button-blue"
    ...
    <div style="z-index: 610;" class="simplebox">
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitBlockForm noEnterSubmit">
                    Start IP: &nbsp;<input name="startip" class="st-forminput" id="StartIPAdd" style="width:150px"
                                           type="text"><br>
                    End IP: &nbsp;&nbsp;<input name="endip" class="st-forminput" id="EndIPAdd" style="width:150px"
                                               type="text">

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="SubmitNewRangeWrapper"><a class="button-blue"
                                                                                                 style="cursor:pointer;"
                                                                                                 id="SubmitNewRange">Add
                            Range of IPs</a></div>
                </form>
            </div>
        </div>
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form3" name="form3" class="Delete noEnterSubmit">
                    <a style="color:#737F89;" id="DeleteFormText"></a><a style="color:#737F89;" id="DeleteFormName"></a><a
                            id="DeleteFormValue" style="display:none;"></a><a id="DeleteFormType"
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:90px;">
                <form id="form1" name="form1" class="SubmitBlockForm noEnterSubmit">
                    ...
                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="SubmitNewServer"><a class="button-blue"
                                                                                           style="cursor:pointer;"
                                                                                           id="SubmitServer">Add Server
                            to Block</a></div>
                </form>
            </div>
        </div>
