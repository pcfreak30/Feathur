    ...
    <div class="simplebox grid360-left" style="height:300px;">
        ...
        <div class="body padding10">
            <div align="center">
                ...
                <a class="button-green" href="admin.php?view=update&action=automatic&value=1">Enable Automatic
                    Updates</a>
                {%/if}
                {%if isempty|AutomaticUpdates == false}
                <a class="button-red" href="admin.php?view=update&action=automatic&value=0">Disable Automatic
                    Updates</a>
                {%/if}
                <br><br>
            </div>
    ...
    <div class="simplebox grid360-right" style="height:300px;">
        ...
        <div class="body padding10">
            <div align="center">
                ...
                <a id="ForceUpdate" class="icon-button"><img src="templates/default/img/icons/button/download.png"
                                                             alt="icon" height="18" width="18"><span>Force Update</span></a>
            </div>
        </div>
    </div>
</div>
