    ...
    <div class="simplebox grid740">
        <div class="titleh">
            ...
            <div class="shortcuts-icons">
                <a class="shortcut tips" id="AddBlock" title="Add IP Block"><img
        ...
        <table class="tablesorter" id="BlockListTable">
            ...
            <tr>
                ...
                <td>
                    <div align="center">{%?block[used]} / {%?block[total]}</div>
                </td>
                <td>
                    <div align="center">
                        <a original-title="Delete" class="icon-button tips DeleteBlock"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?block[name]}"
                           value="{%?block[id]}"><img src="./templates/default/img/icons/32x32/stop32.png" alt="icon"
                                                      height="16" width="16"></a>
                        <a original-title="Edit" class="icon-button tips EditBlock"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?block[name]}"
                           value="{%?block[id]}"><img src="./templates/default/img/icons/32x32/paperpencil32.png"
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:170px;">
                <form id="form1" name="form1" class="SubmitBlockForm noEnterSubmit">
                    Block Name: <input name="newblockname" class="st-forminput" id="NewBlockName" style="width:150px"
                                       type="text"><br>
                    Gateway: &nbsp;<input name="newblockgateway" class="st-forminput" id="NewBlockGateway"
                                          style="width:150px" type="text"><br>
                    Netmask: &nbsp;<input name="newblocknetmask" class="st-forminput" id="NewBlockNetmask"
                                          style="width:150px" type="text">

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="SubmitNewBlockWrapper"><a class="button-blue"
                                                                                                 style="cursor:pointer;"
                                                                                                 id="SubmitNewBlock">Add
                            IP Block</a></div>
                </form>
            </div>
        </div>
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form3" name="form3" class="Delete noEnterSubmit">
                    Do you want to delete the IP block <a style="color:#737F89;" id="DeleteFormName"></a><a
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitEditBlock noEnterSubmit">
                    Block Name: <input name="ipblockname" class="st-forminput" id="EditFormName" value=""
                                       style="width:150px" type="text"><a id="EditFormValue"
                                                                          style="display:none;"></a><br>

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormEditBlock"><a class="button-blue"
                                                                                         style="cursor:pointer;"
                                                                                         id="SubmitEditBlock">Update IP
                            Block</a></div>
                </form>
            </div>
        </div>
