    ...
    <div class="simplebox grid740">
        ...
        <table class="tablesorter" id="vpstable">
            ...
            <tr>
                ...
                <td>
                    <div align="center"><a href="admin.php?view=clients&id={%?entry[user_id]}">{%?entry[username]}</a>
                    </div>
                </td>
                <td>
                    <div align="center">{%?entry[primary_ip]}</div>
                </td>
                <td>
                    <div align="center">{%?entry[type]}</div>
                </td>
            </tr>
            {%/if}
            {%/foreach}
...
<div align="center">
    <div class="simplebox grid740">
        ...
        <table class="tablesorter" id="usertable">
            ...
            <tr>
                <th width="40%">
                    <div align="center">Client Username</div>
                </th>
                <th width="30%">
                    <div align="center">Email Address</div>
                </th>
                <th width="30%">
                    <div align="center">View VPS</div>
                </th>
            </tr>
            </thead>
            {%foreach entry in Result}
            ...
            <tr>
                ...
                <td>
                    <div align="center">{%?entry[email_address]}</div>
                </td>
                <td>
                    <div align="center"><a href="admin.php?view=list&type=search&search=user={%?entry[id]}">Client
                            VPS</a></div>
                </td>
            </tr>
            {%/if}
    ...
    <div class="simplebox grid740">
        ...
        <table class="tablesorter" id="servertable">
            ...
            <tr>
                ...
                <td>
                    <div align="center">{%?entry[ip_address]}</div>
                </td>
                <td>
                    <div align="center">{%?entry[type]}</div>
                </td>
