<br>
<div align="center">First run the feathur installer, then fill out the form bellow.</div><br>
<div align="center">
    ...
    <div style="z-index: 670;width:60%;height:25px;" class="albox small-{%?error[type]}">
        ...
        <div style="float:right;"><a href="#" onClick="return false;" style="margin:-3px;padding:0px;"
                                     class="small-close CloseToggle">x</a></div>
    </div>
    <br><br>
    {%/foreach}
    {%/if}
        ...
        <div class="simplebox grid740" style="text-align:left;">
            ...
            <div class="body">
                ...
                <div class="st-form-line">
                    ...
                    <input id="Port" type="text" name="port" style="width:500px;">
                ...
                <div class="st-form-line">
                    ...
                    <textarea name="key" class="st-forminput" id="key" style="width:510px" rows="3"
                              cols="47"></textarea>
                ...
                <div class="st-form-line">
                    <div align="center">
                        <button class="small blue" id="AddServer">Add Server</button>
                    </div>
                </div>
            </div>
        </div>
