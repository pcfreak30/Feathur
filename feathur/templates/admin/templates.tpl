    ...
    <div class="simplebox grid740">
        <div class="titleh">
            ...
            <div class="shortcuts-icons">
                <a class="shortcut tips" id="NewOpenVZTemplate" title="Add Template"><img
                            src="./templates/default/img/icons/shortcut/addfile.png" width="25" height="25" alt="icon"/></a>
            </div>
        </div>
        <table class="tablesorter" id="OpenVZTable">
            ...
            <tr>
                ...
                <td>
                    <div align="center">OpenVZ</div>
                </td>
                <td>
                    <div align="center">
                        <a original-title="Delete" class="icon-button tips DeleteOpenVZTemplate"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?template[name]}"
                           value="{%?template[id]}"><img src="./templates/default/img/icons/32x32/stop32.png" alt="icon"
                                                         height="16" width="16"></a>
                        <a original-title="Edit" class="icon-button tips EditOpenVZTemplate"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?template[name]}"
                           value="{%?template[id]}"><img src="./templates/default/img/icons/32x32/paperpencil32.png"
                                                         alt="icon" height="16" width="16"></a>
                    </div>
                </td>
            </tr>
            {%/foreach}
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitOpenVZTemplate noEnterSubmit">
                    Template Name: <input name="openvztemplatename" class="st-forminput" id="OpenVZTemplateName"
                                          style="width:150px" type="text"><br>
                    Download URL: &nbsp;<input name="openvztemplateurl" class="st-forminput" id="OpenVZTemplateURL"
                                               style="width:150px" type="text">

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormOpenVZTemplate"><a class="button-blue"
                                                                                              style="cursor:pointer;"
                                                                                              id="SubmitOpenVZTemplate">Add
                            OpenVZ Template</a></div>
                </form>
            </div>
        </div>
    </div>
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form3" name="form3" class="Delete noEnterSubmit">
                    Do you want to delete the template <a style="color:#737F89;" id="DeleteFormName"></a><a
                            id="DeleteFormValue" style="display:none;"></a>?
                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormDelete"><a class="button-blue"
                                                                                      style="cursor:pointer;"
                                                                                      id="ConfirmDelete">Yes</a> <a
                                class="button-blue" style="cursor:pointer;" id="CancelDelete">No</a></div>
                </form>
            </div>
        </div>
    </div>
...
<div id="EditForm" style="display:none;" align="center">
    <div style="z-index: 610;" class="simplebox">
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitOpenVZTemplate noEnterSubmit">
                    Template Name: <input name="openvztemplatename" class="st-forminput" id="EditFormName" value=""
                                          style="width:150px" type="text"><a id="EditFormValue"
                                                                             style="display:none;"></a><br>

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormEditOpenVZTemplate"><a class="button-blue"
                                                                                                  style="cursor:pointer;"
                                                                                                  id="SubmitEditOpenVZTemplate">Update
                            Template</a></div>
                </form>
            </div>
        </div>
...
<div align="center">
    <div class="simplebox grid740">
        <div class="titleh">
            ...
            <div class="shortcuts-icons">
                <a class="shortcut tips" id="NewKVMTemplate" title="Add Template"><img
                            src="./templates/default/img/icons/shortcut/addfile.png" width="25" height="25" alt="icon"/></a>
            </div>
        </div>
        <table class="tablesorter" id="KVMTable">
            ...
            <tr>
                ...
                <td>
                    <div align="center">KVM</div>
                </td>
                <td>
                    <div align="center">
                        <a original-title="Delete" class="icon-button tips DeleteKVMTemplate"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?template[name]}"
                           value="{%?template[id]}"><img src="./templates/default/img/icons/32x32/stop32.png" alt="icon"
                                                         height="16" width="16"></a>
                        <a original-title="Edit" class="icon-button tips EditKVMTemplate"
                           style="padding-left:5px;padding-right:5px;cursor:pointer;" rel="{%?template[name]}"
                           value="{%?template[id]}"><img src="./templates/default/img/icons/32x32/paperpencil32.png"
                                                         alt="icon" height="16" width="16"></a>
                    </div>
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitKVMTemplate noEnterSubmit">
                    Template Name: <input name="kvmtemplatename" class="st-forminput" id="KVMTemplateName"
                                          style="width:150px" type="text"><br>
                    Download URL: &nbsp;<input name="kvmtemplateurl" class="st-forminput" id="KVMTemplateURL"
                                               style="width:150px" type="text">

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormKVMTemplate"><a class="button-blue"
                                                                                           style="cursor:pointer;"
                                                                                           id="SubmitKVMTemplate">Add
                            KVM Template</a></div>
                </form>
            </div>
        </div>
...
<div id="EditForm" style="display:none;" align="center">
    <div style="z-index: 610;" class="simplebox">
        ...
        <div style="z-index: 590;" class="body padding10">
            <div style="height:120px;">
                <form id="form1" name="form1" class="SubmitKVMTemplate noEnterSubmit">
                    Template Name: <input name="kvmtemplatename" class="st-forminput" id="EditFormName" value=""
                                          style="width:150px" type="text"><a id="EditFormValue"
                                                                             style="display:none;"></a><br>

                    <div style="padding:12px;"></div>
                    <div align="center" style="margin-bottom:5px;" id="FormEditKVMTemplate"><a class="button-blue"
                                                                                               style="cursor:pointer;"
                                                                                               id="SubmitEditKVMTemplate">Update
                            Template</a></div>
                </form>
            </div>
        </div>
