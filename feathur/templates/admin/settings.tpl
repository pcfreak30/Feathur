        ...
        <form id="SettingsForm" name="settings" method="post" action="">
            <div id="tabs-1" align="left">
                ...
                <div class="st-form-line">
                    ...
                    <input name="title" type="text" class="st-forminput" id="title" style="width:400px"
                           value="{%?Title}"/>
                ...
                <div class="st-form-line">
                    ...
                    <input name="description" type="text" class="st-forminput" id="description" style="width:400px"
                           value="{%?Description}"/>
                ...
                <div class="st-form-line">
                    ...
                    <input name="panel_url" type="text" class="st-forminput" id="panel_url" style="width:400px"
                           value="{%?PanelURL}"/>
                ...
                <div class="st-form-line">
                    ...
                    <label class="margin-right10"><input type="checkbox" name="maintenance" value="1"
                                                         {%if isset|Maintenance == true}{%if isempty|Maintenance == false}selected="selected"{%/if}{%/if}
                                                         id="maintenance" class="uniform"/> Enabled</label>
                ...
                <div class="st-form-line">
                    ...
                    <select name="update_type" id="update_type" class="uniform">
                        <option value="develop"
                                {%if isset|UpdateType == true}{%if UpdateType == develop}selected="selected"{%/if}{%/if}>
                            Development
                        </option>
                        <option value="develop-develop"
                                {%if isset|UpdateType == true}{%if UpdateType == develop-develop}selected="selected"{%/if}{%/if}>
            ...
            <div id="tabs-2" align="left">
                ...
                <div class="st-form-line">
                    ...
                    <select name="mail" id="mail" class="uniform">
                        ...
                        <option value="1" {%if isset|Mail == true}{%if Mail == 1}selected="selected"{%/if}{%/if}>Send
                            Grid
                        </option>
                        <option value="2" {%if isset|Mail == true}{%if Mail == 2}selected="selected"{%/if}{%/if}>
                            Mandrill
                        </option>
                    </select>
                ...
                <div id="mail-info">
                    <div class="st-form-line">
                        ...
                        <input name="mail_username" type="text" class="st-forminput" id="mail_username"
                               style="width:400px" value="{%if isset|MailUsername == true}{%?MailUsername}{%/if}"/>

                        <div class="clear"></div>
                    </div>
                    <div class="st-form-line">
                        <span class="st-labeltext">SMTP Password: </span>
                        <input name="mail_password" type="password" class="st-forminput"
                               {%if isset|MailPassword == true}value="password"{%/if} id="mail_password"
                               style="width:400px"/>
            ...
            <div id="tabs-3">
                ...
                <div class="st-form-line">
                    ...
                    <select name="bandwidth_accounting" id="bandwidth_accounting" class="uniform">
                        <option value="upload"
                                {%if isset|BandwidthAccounting == true}{%if BandwidthAccounting == upload}selected="selected"{%/if}{%/if}>
                            Upload Only
                        </option>
                        <option value="download"
                                {%if isset|BandwidthAccounting == true}{%if BandwidthAccounting == download}selected="selected"{%/if}{%/if}>
                            Download Only
                        </option>
                        <option value="both"
                                {%if isset|BandwidthAccounting == true}{%if BandwidthAccounting == both}selected="selected"{%/if}{%/if}>
            ...
            <div id="tabs-4">
                ...
                <div class="st-form-line">
                    ...
                    <input name="template" type="text" class="st-forminput" id="template" style="width:400px"
                           value="{%?Template}"/>
                ...
                <div class="st-form-line">
                    ...
                    <input name="admin_template" type="text" class="st-forminput" id="admin_template"
                           style="width:400px" value="{%?AdminTemplate}"/>
