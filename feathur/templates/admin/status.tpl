<div id="Status" style="margin:5px;">
    ...
    <br><br>
    {%/if}
    <div style="width:30px;display:inline;white-space:nowrap;">Last update: <a id="timer"
                                                                               style="white-space:nowrap;">0</a> seconds
        ago
    </div>
    <br><br>
    {%if isset|Statistics == true}
    {%foreach server in Statistics}
    <div class="simplebox grid360-{%if isempty|server[type] == true}right{%/if}{%if isempty|server[type] == false}left{%/if}"
         style="padding:3px;padding-bottom:10px;">
        <div class="titleh">
            <h3>
                <div style="width:39%;float:left;">
                    <img src="./templates/status/{%if isempty|server[status] == true}offline{%/if}{%if isempty|server[status] == false}online{%/if}.png"
                         style="width:10px;height:10px;">{%if isset|server[name] == true}{%?server[name]}{%/if}
                </div>
                ...
                <div style="width:59%;float:right;padding-right:5px;" align="right">
                    ...
                    {%if isempty|server[load_average] == false}{%if isempty|server[bandwidth] == false}
                    &nbsp;|&nbsp;{%/if}{%/if}
