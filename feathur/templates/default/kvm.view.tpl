...
<ul>
    ...
    {%if UserPermissions == 7}
    <li><a href="#tabs-3">Admin</a></li>{%/if}
</ul>
<div id="tabs-1" style="height:500px;">
    <table>
        <tr>
            <td style="width:20px;">
                <div align="center" id="Status" style="width:30px;"><img src="templates/default/img/loading/6.gif"
                                                                         style="padding:0px;margin:0px;"></div>
            </td>
            <td width="30%" align="left">
                <h5 style="padding-left:10px;">VPS - KVM
                    <div id="VPSHostname">({%?vps[hostname]})</div>
                </h5>
            </td>
        ...
        <tr>
            <td colspan="3">
                ...
                <div align="center" style="width:100%">
                    {%if UserPermissions == 7}{%if vps[suspended] == 1}
                    <div class="albox warningbox" style="width:50%;">This VPS is Suspended.</div>{%/if}{%/if}
                    <div style="width:90%;white-space:nowrap;overflow:hidden;text-align:center;">
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large green GenericAction" style="width:100px;" value="boot">
                                <div align="center"><span class="icon-play icon-2x"></span><br>Start</div>
                            </button>
                        </div>
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large red GenericAction" style="width:100px;" value="shutdown">
                                <div align="center"><span class="icon-stop icon-2x"></span><br>Stop</div>
                            </button>
                        </div>
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large orange GenericAction" style="width:100px;" value="reboot">
                                <div align="center"><span class="icon-refresh icon-2x"></span><br>Restart</div>
                            </button>
                        </div>
                        {%if UserPermissions == 7}
                        {%if vps[suspended] == 1}
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large red GenericAction" style="width:100px;" value="unsuspend">
                                <div align="center"><span class="icon-unlock icon-2x"></span><br>Unsuspend</div>
                            </button>
                        </div>
                        {%/if}
                        {%if vps[suspended] == 0}
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large red GenericAction" style="width:100px;" value="suspend">
                                <div align="center"><span class="icon-lock icon-2x"></span><br>Suspend</div>
                            </button>
                        </div>
                        {%/if}
                        {%/if}
                    ...
                    <div style="z-index: 670;width:90%;height:25px;" class="albox small-caution">
                        <div id="Status" style="padding:4px;padding-left:5px;width:100%;">
                            <strong>Notice:</strong> Starting/Stopping from Feathur kills it immediately. Use shutdown
                            -r now on your VPS if possible!
                        </div>
                    </div>
                </div>
                <br><br>
...
<div style="z-index: 500;text-align:left;width:95%;margin:2px;" class="simple-tips">
    ...
    <p>Most of the settings on this page are temporary in nature. They will only remain until your VPS is rebooted from
        Feathur. This is in an effort to help protect the security of your passwords and settings. Feathur does not
        store passwords in plain text. Sorry for any inconvenience...</p>
            ...
            <td width="70%">
                <select id="SelectedTemplate" style="width:100%">
                    ...
                    <option value="{%?template[id]}"
                            {%if template[primary] == 1}selected="selected"{%/if}>{%?template[name]}</option>
                    {%/foreach}
                    {%/if}
        ...
        <tr>
            ...
            <td width="70%">
                <select id="SelectedOrder" style="width:100%">
                    <option value="hd"
                            {%if isset|vps[boot_order] == true}{%if vps[boot_order] == hd}selected="selected"{%/if}{%/if}>
                        Hard Disk, CD-ROM
                    </option>
                    <option value="cd"
                            {%if isset|vps[boot_order] == true}{%if vps[boot_order] == cd}selected="selected"{%/if}{%/if}>
                        CD-ROM, Hard Disk
                    </option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td width="70%">
                <select id="SelectedNIC" style="width:100%">
                    <option value="rtl8139"
                            {%if isset|vps[network_driver] == true}{%if vps[network_driver] == rtl8139}selected="selected"{%/if}{%/if}>
                        Realtek 8139
                    </option>
                    <option value="e1000"
                            {%if isset|vps[network_driver] == true}{%if vps[network_driver] == e1000}selected="selected"
                            {%/if}{%/if}{%if isset|vps[network_driver] == false}selected="selected"{%/if}>Intel
                        (Recommended)
                    </option>
                    <option value="virtio"
                            {%if isset|vps[network_driver] == true}{%if vps[network_driver] == virtio}selected="selected"{%/if}{%/if}>
                        VirtIO
                    </option>
                    <option value="ne2k_pci"
                            {%if isset|vps[network_driver] == true}{%if vps[network_driver] == ne2k_pci}selected="selected"{%/if}{%/if}>
                        Realtek 8029
                    </option>
                    <option value="pcnet"
                            {%if isset|vps[network_driver] == true}{%if vps[network_driver] == pcnet}selected="selected"{%/if}{%/if}>
                        PCNet
                    </option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td width="70%">
                <select id="SelectedDisk" style="width:100%">
                    <option value="scsi"
                            {%if isset|vps[disk_driver] == true}{%if vps[disk_driver] == scsi}selected="selected"{%/if}{%/if}>
                        SCSI
                    </option>
                    <option value="ide"
                            {%if isset|vps[disk_driver] == true}{%if vps[disk_driver] == ide}selected="selected"
                            {%/if}{%/if}{%if isset|vps[disk_driver] == false}selected="selected"{%/if}>IDE (Recommended)
                    </option>
                    <option value="virtio"
                            {%if isset|vps[disk_driver] == true}{%if vps[disk_driver] == virtio}selected="selected"{%/if}{%/if}>
                        VirtIO
                    </option>
                </select>
            </td>
...
<div id="tabs-3" style="height:1500px">
    ...
    <div class="simplebox grid340-left">
        ...
        <table class="tablesorter" style="height:300px;">
            ...
            <tr>
                ...
                <td><input id="AdminCPULimit" type="text" name="AdminCPULimit" value="{%?vps[cpulimit]}"
                           style="width:90%"/></td>
            </tr>
            <tr>
                <td style="width:50%">Bandwidth Limit (GB):</td>
                <td><input id="AdminBandwidthLimit" type="text" name="AdminBandwidthLimit"
                           value="{%?vps[bandwidthlimit]}" style="width:90%"/></td>
            </tr>
            <tr>
                <td colspan="2">
                    <div align="center">
                        <button class="small blue" id="UpdateVPS">Update VPS</button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="simplebox grid340-left">
        ...
        <table class="tablesorter" style="height:122px">
            ...
            <tr>
                <td colspan="2">
                    <div align="center">
                        <button class="small blue" id="AddIPAddresses">Add IP Addresses</button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="simplebox grid340-right">
        ...
        <table class="tablesorter">
            ...
            <tr>
                <td colspan="2">
                    <div align="center">
                        <button class="small blue" id="RemoveIPAddress">Remove IP Address</button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="simplebox grid340-left">
        ...
        <table class="hide-message tablesorter">
            <tr>
                <td>
                    <input type="checkbox" name="VerifyTerminate" id="VerifyTerminate" value="1"> I understand that this
                    will completely destroy this poor users pitiful VPS.
                </td>
            </tr>
            <tr>
                <td>
                    <div align="center">
                        <button class="small orange" id="Terminate">Terminate</button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="simplebox grid340-right">
        ...
        <table class="tablesorter">
            ...
            <tr>
                <td colspan="2">
                    <div align="center">
                        <button class="small blue" id="ManuallyAssignIP">Add IP Address</button>
                    </div>
                </td>
            </tr>
        </table>
