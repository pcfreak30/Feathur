...
<ul>
    ...
    {%if UserPermissions == 7}
    <li><a href="#tabs-6">Admin</a></li>{%/if}
</ul>
<div id="tabs-1">
    <table>
        <tr>
            ...
            <td width="30%" align="left">
                <h5 style="padding-left:10px;">VPS - OpenVZ
        ...
        <tr>
            <td colspan="3">
                ...
                <div align="center" style="width:100%">
                    {%if UserPermissions == 7}
                    {%if vps[suspended] == 1}
                    <div class="albox warningbox" style="width:50%;">This VPS is Suspended.</div>{%/if}
                    {%if vps[suspended] == 2}
                    <div class="albox warningbox" style="width:50%;">This VPS is Suspended due to bandwidth overage.
                    </div>{%/if}
                    {%/if}
                    <div style="width:90%;white-space:nowrap;overflow:hidden;text-align:center;">
                        ...
                        <div style="display:inline-block;vertical-align:middle;padding-left:15px;padding-right:15px;"
                             align="center">
                            <button class="large black GenericAction" style="width:100px;" value="kill">
                                <div align="center"><span class="icon-remove icon-2x"></span><br>Kill</div>
                            </button>
                        </div>
                        {%if UserPermissions == 7}
                        {%if vps[suspended] == 1}
                ...
                <div align="center" style="width:100%">
                    <div id="Statistics"><img src="templates/default/img/loading/7.gif" style="padding:0px;margin:0px;">
                    </div>
                </div>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <div align="center">
                        <div id="TunTapButton">
                            <a href="#" id="TunTap"
                               class="button-{%if isempty|vps[tuntap] == true}green{%/if}{%if isempty|vps[tuntap] == false}red{%/if}"
                               style="color:#FFFFFF;">
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <div align="center">
                        <div id="PPPButton">
                            <a href="#" id="PPP"
                               class="button-{%if isempty|vps[ppp] == true}green{%/if}{%if isempty|vps[ppp] == false}red{%/if}"
                               style="color:#FFFFFF;">
                ...
                <td width="60%">
                    ...
                    <div align="center">
                        <div id="IPTablesButton">
                            <a href="#" id="IPTables"
                               class="button-{%if isempty|vps[iptables] == true}green{%/if}{%if isempty|vps[iptables] == false}red{%/if}"
                               style="color:#FFFFFF;">
    ...
    <div align="center" style="width:100%">
        ...
        <div class="simplebox grid360">
            ...
            <table class="tablesorter">
                ...
                <tr>
                    <td colspan="2"><input type="checkbox" name="VerifyRebuild" id="VerifyRebuild" value="1"> I
                        understand that this procedure will destroy my VPS and all data on it, and start with a desired
                        template.
                    </td>
                </tr>
                <tr>
...
<div id="tabs-4">
    <div align="center" style="width:100%">
        <div style="z-index: 500;text-align:left;" class="simple-tips">
            ...
            <ul>
                <li>You can use this command center to issue commands to your VPS even if you can''t connect via SSH.
                </li>
                <li><strong>Notice:</strong> Commands issued are not successive. Each command is executed independently.
                </li>
                ...
                <tr>
                    <td>
                        <div style="background:#000000;color:#FFFFFF;height:20px;overflow-x:hidden;overflow-y:hidden;padding:5px;border-bottom:1px solid grey;">
                            <div style="float:right;width:60px;z-index:-1;visibility:hidden;vertical-align:center;"
                                 align="right" id="ConsoleLoading"><img src="./templates/default/img/loading/9.gif">
                            </div>
                        </div>
                        <div style="background:#000000;color:#FFFFFF;overflow-x:hidden;overflow-y:visible;height:300px;padding:5px;"
                             id="ConsoleOutput"></div>
                    </td>
                </tr>
                <tr>
...
<div class="simplebox grid340-left">
    ...
    <table class="tablesorter" style="height:500px;">
        ...
        <tr>
            ...
            <td><input id="AdminCPUUnits" type="text" name="AdminCPUUnits" value="{%?vps[cpuunits]}" style="width:90%"/>
            </td>
        </tr>
        <tr>
            <td style="width:50%">CPU Limit (100/core):</td>
            <td><input id="AdminCPULimit" type="text" name="AdminCPULimit" value="{%?vps[cpulimit]}" style="width:90%"/>
            </td>
        </tr>
        <tr>
            <td style="width:50%">Bandwidth Limit (GB):</td>
            <td><input id="AdminBandwidthLimit" type="text" name="AdminBandwidthLimit" value="{%?vps[bandwidthlimit]}"
                       style="width:90%"/></td>
        </tr>
        <tr>
...
<div class="simplebox grid340-left">
    ...
    <table class="tablesorter">
        ...
        <tr>
            <td colspan="2">
                <div align="center">
                    <button class="small blue" id="TransferVPS">Transfer VPS</button>
                </div>
            </td>
        </tr>
    </table>
