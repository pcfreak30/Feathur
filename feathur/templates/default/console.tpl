...
<head>
    ...
    <!--[if lt IE 7]>
    <link type='text/css' href='css/basic_ie.css' rel='stylesheet' media='screen'/> <![endif]-->
...
<div align="center" style="height:500px;verical-align:center;">
        ...
        <div class="simplebox grid360">
            ...
            <table class="tablesorter">
                <tr>
                    ...
                    <td width="60%"><input id="Hostname" type="text" name="hostname" value="{%?vps[primary_ip]}"
                                           style="width:100%"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <div align="center">
                            <button class="button small orange" id="StartConsole" type="submit">Start Java Console
                            </button>
                        </div>
                    </td>
                </tr>
    ...
    <applet width="640" height="480"
            ...
            code="com.sshtools.sshterm.SshTermApplet" codebase="./includes/library/sshterm/"
